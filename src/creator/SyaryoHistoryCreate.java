...
public class SyaryoHistoryCreate extends HiveDB {
    ...
    public static void main(String[] args) throws IOException {
        ...
        syaryoMap = new EQPSyaryoData().addEQPSyaryo(con, pw, syaryoMap, noneTypeSearch);
        ...
        syaryoMap = new EQPKeirekiData().addSyaryoKeireki(con, pw, syaryoMap, noneTypeSearch);
        ...
        syaryoMap = new SyaryoData().addSyaryoCategory(con, pw, syaryoMap, noneTypeSearch);
        ...
        syaryoMap = new ServiceData().addService(con, pw, syaryoMap, noneTypeSearch);
        ...
        syaryoMap = new OrderData().addOrder(con, pw, syaryoMap, noneTypeSearch);
        ...
        syaryoMap = new WorkData().addWork(con, pw, syaryoMap, noneTypeSearch);
        ...
        syaryoMap = new PartsData().addParts(con, pw, syaryoMap, noneTypeSearch);
        ...
        syaryoMap = new SellsData().addSell(con, pw, syaryoMap, noneTypeSearch);
