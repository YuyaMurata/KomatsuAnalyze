...
public class CSVViewerOutput {
    ...
    public static Integer none(String filename, DataRuleFilter filter, Map<String, Integer> selectData, List<SyaryoObject1> syaryos) {
        int n = 0;
    ...
    public static Integer time(String filename, DataRuleFilter filter, Map<String, Integer> selectData, List<SyaryoObject1> syaryos) {
        int n = 0;
    ...
    public static Integer sql(String filename, DataRuleFilter filter, Map<String, Map<String, Integer>> selectData, List<SyaryoObject1> syaryos) {
