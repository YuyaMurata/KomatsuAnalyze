...
public class CommandlinePython {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        File file = new File("py\\smr_date_graph.py");
        
        String[] out = execCommand(new String[]{"python", file.getAbsolutePath()});
    ...
    /**
         ...
         *
         * @see execCommand(String[] cmds) ※実行するコマンドに引数（パラメータ）がある場合は、
         * 以下を使用してください。
         * @param cmd 実行するコマンド
