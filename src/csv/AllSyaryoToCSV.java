...
public class AllSyaryoToCSV {
    ...
    public static void main(String[] args) {
        ...
        String kisy = "WA470";
        Map<String, SyaryoObject1> syaryoMap = new JsonToSyaryoObj().reader("json\\syaryo_obj_" + kisy + "_form.json");
    ...
    public static void order(String filename, Map<String, SyaryoObject1> syaryoMap) {
        PrintWriter pw;
    ...
    public static void komtrax(String filename, Map<String, SyaryoObject1> syaryoMap) {
        PrintWriter pw1, pw2;
        ...
        try {
            ...
            List<SyaryoObject1> syaryos = syaryoMap.values().stream()
                    .filter(s -> s.getType().equals("8"))
                    .collect(Collectors.toList());

            for (SyaryoObject1 syaryo : syaryos) {
    ...
    public static void service(String filename, Map<String, SyaryoObject1> syaryoMap) {
        PrintWriter pw;
    ...
    public static void komtraxError(String filename, Map<String, SyaryoObject1> syaryoMap) {
        PrintWriter pw;
    ...
    public static void orderDataCount(String filename, Map<String, SyaryoObject1> syaryoMap, String rule) {
        try {
    ...
    public static void workDataCount(String filename, Map<String, SyaryoObject1> syaryoMap, String rule) {
        try {
    ...
    public static void workDataCount2(String filename, Map<String, SyaryoObject1> syaryoMap, String rule) {
        try {
    ...
    public static void smrOrderCount(String filename, Map<String, SyaryoObject1> syaryoMap){
        try {
    ...
    public static void smrReachCount(String filename, Integer smriv,Map<String, SyaryoObject1> syaryoMap){
        try{
